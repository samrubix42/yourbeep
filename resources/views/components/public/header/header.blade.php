...
" class="w-full">
    ...
    <div class="fixed top-0 left-0 right-0 z-50 bg-slate-900 border-b border-slate-800 px-4 py-2 sm:py-2.5 text-center flex items-center justify-center gap-2 sm:gap-3 shadow-md">
        <span class="inline-flex items-center gap-1 sm:gap-1.5 text-xs sm:text-sm font-bold text-rose-400 whitespace-nowrap">
            <span class="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-rose-500 animate-pulse"></span>
            ⚡ ONLY 20 SEATS LEFT:
        </span>
        <span class="text-xs sm:text-sm text-slate-100 font-light hidden sm:inline">
            Register now to secure your live training portal and onboarding bonuses!
        </span>
        <span class="text-[11px] sm:text-sm text-slate-100 font-light inline sm:hidden">
            Register now to secure your spot!
        </span>
        <div class="inline-flex items-center gap-1 sm:gap-1.5 text-rose-400 font-mono font-bold text-xs bg-rose-500/10 px-2 sm:px-2.5 py-0.5 rounded border border-rose-500/25 shadow-sm whitespace-nowrap">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-5">
        <div class="flex items-center justify-between border-b border-slate-100 pb-5">
            <div class="flex items-center gap-4">
                ...
                <img src="/app_logo.png" alt="YourBeep Logo" class="h-9 sm:h-11 w-auto object-contain transition-opacity duration-300 hover:opacity-85">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://www.yourbeep.com/courses/6a41f00fdc0af597eb154d43" class="text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg hover:shadow-teal-500/20 transition-all duration-200 hover:-translate-y-0.5 active:scale-95">
                    Enroll Now
                </a>
            </div>
        </div>
