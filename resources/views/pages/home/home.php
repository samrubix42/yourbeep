...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    /** @var array<int, array{id: int, name: string, role: string, content: string, rating: int, avatar: string|null}> */
    public array $testimonials = [];

    /**
     * Mount the component and generate 200 Indian purchasers.
     */
    ...
    {
        $this->reset(['name', 'email', 'phone', 'success', 'price']);
    }
};
